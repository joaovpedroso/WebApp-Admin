...
<div class="container">
    ...
    <form method="post" class="form" action="/usuarios">
        <section class="content-header">
            <legend>Manutenção de Cadastro</legend>
        </section>
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="date" name="datadenascimento" id="datadenascimento" class="form-control" 
                                   <?php 
                                    $datadenascimento = $this->dados["pessoa"]->datadenascimento;
                                    $datadenascimento = explode("/", $datadenascimento);
                                    $dia = $datadenascimento[0];
                                    $mes = $datadenascimento[1];
                                    $ano = $datadenascimento[2];
                                    $datadenascimento = $ano."/".$mes."/".$dia;
                                    $datadenascimento = str_replace("/", "-", $datadenascimento);
                                    ?>
                                   value="<?=$datadenascimento;?>"  
                                   onblur="validarData(this.value)" required
            ...
            <br>
            <button type="submit" name="updateform" class="btn btn-warning pull-left">
