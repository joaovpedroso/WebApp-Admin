...
class Endereco extends Model{
    ...
    public function Insert(){
        ...
        $pdo        = Conecta::getPdo();
        $sql        = "INSERT INTO $this->table (idendereco, idcpf, cep, endereco, numero, complemento, idestado, idcidade, idtipoendereco, bairro) VALUES "
                . " (NULL, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $consulta   = $pdo->prepare($sql);
        ...
        $consulta   ->bindValue(6, $this->getIdestado() );
    ...
    public function Update($idendereco){
        ...
        $sql        = "UPDATE $this->table SET idcpf = ? , cep = ? , endereco = ? , numero = ? , complemento = ? , idestado = ? , idcidade = ? , idtipoendereco = ?, bairro = ? WHERE idendereco = ? LIMIT 1";
        $consulta   = $pdo->prepare($sql);
        $consulta   ->bindValue(1, $this->getIdcpf() );
        $consulta   ->bindValue(2, $this->getCep() );
        $consulta   ->bindValue(3, $this->getEndereco() );
